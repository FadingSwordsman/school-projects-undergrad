...
public class Grass extends AbstractLiveable
{
    ...
    {
	super(PlaceType.GRASS, world, location, world.getSimulationSettings().getGrassSettings().getGrassInitialUpdatePeriod(), world.getSimulationSettings()
		.getGrassSettings().getGrassBirthMass(), mass);
	settings = world.getSimulationSettings().getGrassSettings();
	updateNextMove(world.getRandom().nextInt(getUpdatePeriod()) + 1);
	getWorld().createLiveable(this);
    }
